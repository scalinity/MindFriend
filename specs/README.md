...
| P9       | Streak Recovery     | [10-streak-recovery.md](./10-streak-recovery.md)         | Reduces churn from broken streaks |
| P10      | Re-engagement Flows | [11-reengagement-flows.md](./11-reengagement-flows.md)   | Wins back lapsed users            |
| P11      | Quest Choice        | [12-quest-choice.md](./12-quest-choice.md)               | Autonomy increases completion     |
| P12      | Mood-Adaptive Home  | [13-mood-adaptive-home.md](./13-mood-adaptive-home.md)   | Personalized experience           |
| P13      | Celebration Sharing | [14-celebration-sharing.md](./14-celebration-sharing.md) | Viral growth + dopamine hits      |
| P14      | Onboarding Buddy    | [15-onboarding-buddy.md](./15-onboarding-buddy.md)       | Viral loop + accountability       |
