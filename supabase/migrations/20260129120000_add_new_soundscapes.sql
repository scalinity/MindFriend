...
-- URLs are constructed dynamically from app.settings.supabase_url

DO $$
DECLARE
    v_base_url TEXT;
BEGIN
    v_base_url := current_setting('app.settings.supabase_url', true) || '/storage/v1/object/public/soundscapes';
