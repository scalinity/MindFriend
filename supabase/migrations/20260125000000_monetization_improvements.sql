...
-- =============================================================================
-- PART 4: Family invitations table
-- =============================================================================
...
INSERT INTO badges (code, name, title, description, icon_name, category) VALUES
  ('premium_supporter', 'Premium Supporter', 'Premium Supporter', 'Thanks for supporting MindFriend!', 'star.fill', 'subscription'),
  ('annual_achiever', 'Annual Achiever', 'Annual Achiever', 'Committed to a year of growth', 'calendar.badge.checkmark', 'subscription'),
  ('family_champion', 'Family Champion', 'Family Champion', 'Leading your family''s wellness journey', 'person.3.fill', 'subscription')
