...
-- Update sleep_content URLs to use correct project URL format
-- Note: These files don't exist yet - they need to be uploaded to Supabase Storage
-- For now, mark all content as inactive
...
SET
    ...
    audio_url = REPLACE(
        ...
        'https://***REMOVED***/storage/v1/object/public/sleep-content/'
    )
