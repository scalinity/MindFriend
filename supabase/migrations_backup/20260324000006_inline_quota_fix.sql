-- Inline version of quota check - no separate ensure_profile_exists call
-- This avoids potential nested function call issues
...
BEGIN
  ...
  IF NOT v_profile_exists THEN
    -- Get user info and create profile
...
COMMENT ON FUNCTION check_and_increment_ai_quota IS 'Atomically checks and increments AI quota. Auto-creates missing profiles (inlined version).';
