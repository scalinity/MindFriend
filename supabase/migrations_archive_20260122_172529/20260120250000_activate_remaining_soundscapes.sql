...
BEGIN
    ...
    IF EXISTS (
        ...
        SET
            is_active = true,
            audio_url = 'https://zfaucivtzfwnrijsbfug.supabase.co/storage/v1/object/public/sleep-content/soundscapes/white-noise.m4a',
        ...
        SET
            is_active = true,
            audio_url = 'https://zfaucivtzfwnrijsbfug.supabase.co/storage/v1/object/public/sleep-content/soundscapes/thunderstorm.m4a',
            duration_seconds = 1800 -- 30 minutes
        ...
        SET
            is_active = true,
            audio_url = 'https://zfaucivtzfwnrijsbfug.supabase.co/storage/v1/object/public/sleep-content/soundscapes/campfire.m4a',
            duration_seconds = 1800 -- 30 minutes
        ...
        SET
            is_active = true,
            audio_url = 'https://zfaucivtzfwnrijsbfug.supabase.co/storage/v1/object/public/sleep-content/soundscapes/binaural.m4a',
            duration_seconds = 1800 -- 30 minutes
    ...
    ELSE
        RAISE NOTICE 'sleep_content table does not exist yet, skipping soundscape activation';
    END IF;
END $$;
