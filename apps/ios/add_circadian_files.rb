...
files_to_add = [
  "MindFriendApp/Core/Models/CircadianModels.swift",
  "MindFriendApp/Core/Services/ChronotypeClassifier.swift",
  "MindFriendApp/Core/Services/VulnerabilityPredictor.swift",
  "MindFriendApp/Core/Services/VulnerabilityRefiner.swift",
  "MindFriendApp/Core/Services/CircadianVulnerabilityEngine.swift",
  "MindFriendApp/Core/Services/ArmorScheduler.swift"
]
