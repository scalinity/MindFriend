...
# Files to add
files = [
  'MindFriendApp/Features/Achievements/Components/ParticleEmitter.swift',
  'MindFriendApp/Features/Achievements/Components/TierProgressView.swift',
  'MindFriendApp/Features/Achievements/Components/XPCompactWidget.swift'
]
