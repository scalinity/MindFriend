...
views = [
  "MindFriendApp/Features/WellbeingDebt/WellbeingDebtDashboardView.swift",
  "MindFriendApp/Features/WellbeingDebt/DebtBreakdownView.swift",
  "MindFriendApp/Features/WellbeingDebt/RecoveryProgramView.swift"
]

views.each do |view_path|
  group, filename = find_or_create_group(project, view_path)
  file_ref = group.new_reference(filename)
  file_ref.source_tree = '<group>'
  file_ref.last_known_file_type = 'sourcecode.swift'
  app_target.source_build_phase.add_file_reference(file_ref)
  puts "Added: #{view_path}"
end

project.save
puts "✓ All wellbeing debt view files added successfully"
