...
files_to_add = [
  {
    path: 'MindFriendApp/Features/Exercises/SavedExercisesView.swift',
    groups: ['MindFriendApp', 'Features', 'Exercises']
  },
  {
    path: 'MindFriendApp/Features/Exercises/GenerateExerciseView.swift',
    groups: ['MindFriendApp', 'Features', 'Exercises']
  },
  {
    path: 'MindFriendApp/Features/Exercises/GeneratedExercisePlayerView.swift',
    groups: ['MindFriendApp', 'Features', 'Exercises']
  }
]
