...
# Add WellbeingDebtModels.swift
models_path = "MindFriendApp/Core/WellbeingDebtModels.swift"
group, filename = find_or_create_group(project, models_path)
file_ref = group.new_reference(filename)
file_ref.source_tree = '<group>'
file_ref.last_known_file_type = 'sourcecode.swift'
app_target.source_build_phase.add_file_reference(file_ref)
puts "Added: #{models_path}"

# Add WellbeingDebtService.swift
service_path = "MindFriendApp/Core/Services/WellbeingDebtService.swift"
group, filename = find_or_create_group(project, service_path)
file_ref = group.new_reference(filename)
file_ref.source_tree = '<group>'
file_ref.last_known_file_type = 'sourcecode.swift'
app_target.source_build_phase.add_file_reference(file_ref)
puts "Added: #{service_path}"
