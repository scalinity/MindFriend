...
// Prisma 7.x requires database adapter
  ...
  const questTemplates = [
    {
      ...
      title: 'Box Breathing',
      description:
        'A calming 4-4-4-4 breathing exercise to reduce stress and center yourself',
      estimatedMinutes: 5,
      difficulty: 1,
      ...
      instructionsJson: {
        ...
        repeatCycles: 5,
        completionMessage:
          'Great job! Notice how you feel now compared to before.',
      },
    },
    {
      type: 'walk',
      title: 'Mindful Walk',
      description:
        'A short mindful walk outside to clear your mind and get moving',
      estimatedMinutes: 10,
      difficulty: 1,
      ...
      instructionsJson: {
        ...
        completionMessage:
          'Well done! Movement and fresh air do wonders for the mind.',
      },
    },
    {
      type: 'journal',
    ...
    },
    {
      ...
      instructionsJson: {
        steps: [
          ...
          {
            instruction:
              'Take a 5-minute break - stretch, walk, rest your eyes',
            durationSeconds: 300,
            type: 'break',
          },
        ],
    ...
    },
    {
      ...
      instructionsJson: {
        steps: [
          {
            instruction:
              'Think of someone who has helped or supported you recently',
            durationSeconds: 30,
          },
          {
        ...
        completionMessage:
          'Spreading kindness benefits both you and the recipient!',
      },
    },
    {
      type: 'stretch',
      ...
      instructionsJson: {
        ...
        completionMessage:
          'Your body thanks you! Regular stretching prevents tension buildup.',
      },
    },
  ];

  // Clear existing quest templates and recreate
  ...
  const exercises = [
    {
      ...
      description:
        'A calming technique that helps reduce anxiety and promote sleep',
      durationSeconds: 300,
...
Notice the sense of relaxation throughout.`,
    ...
    },
    {
      ...
      description:
        'A sensory awareness exercise to bring you back to the present',
      durationSeconds: 300,
      contentKind: 'text' as const,
...
When ready, slowly bring your awareness back to the present.`,
  ...
  // Clear existing crisis resources and recreate
